                ...
                <div class="container">
                    <div class="row row-ibl mid">
                        ...
                        <div class="col-md-2 col-xs-12 centermb">
                            ...
                            <a class="logo" title="Verus®" href="/">
                                
                                <img src="./view/images/logo.jpg" alt="logo Verus®">
                        ...
                        <div class="col-md-10 col-xs-12 text-right hidden-xs hidden-sm">
                            <nav class="main-nav">
                                <ul id="menu-main-menu" class="">
                                    ...
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                                        <a href="/shop-verus" title="Shop Verus®">Rượu Vang </a>
                                        <!-- <ul class="sub-menu">
                                    ...
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                                        ...
                                        <!-- <ul class="sub-menu">
                                            ...
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                                                <a href="/verus-x-lien-quan-1" title="Verus® x Liên Quân">Verus® x Liên Quân</a>
                                                <ul class="sub-menu">
                                            ...
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                                                <a href="/verus-x-biti-s-hunter" title="Verus® x Biti's Hunter">Verus® x Biti's Hunter</a>
                                                <ul class="sub-menu">
                    ...
                    <div class="main">
                        <div class="bar">
                            <a class="nv-logo" href="/" title="">
                                <img style="max-width: 90px;" src="images/logo.png" alt="logo Verus®">
                            </a>
                            <form class="search-fr" action="/search">
                            ...
                            <nav>
                                <ul id="menu-main-menu2">
                                    ...
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                                        <a href="/shop-verus">Shop Verus®</a>
                                        <ul class="sub-menu">
                                    ...
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                                                <a href="/verus-x-lien-quan-1">Verus® x Liên Quân</a>
                                                <ul class="sub-menu">
                                            ...
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                                                <a href="/verus-x-biti-s-hunter">Verus® x Biti's Hunter</a>
                                                <ul class="sub-menu">
                                    ...
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="/account/login"> Register / Sign in</a></li>
