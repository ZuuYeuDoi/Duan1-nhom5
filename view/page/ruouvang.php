...
<div class="bn1">
    <img class="anhbn1" src=".\upload\bannerr1.jpg" alt="">
    <div class="bn2">
        <h1 class="mt-4 text-primary">Rượu Vang</h1>
        <h2>Rượu vang là một thức uống có cồn làm từ nho lên men. Nấm men tiêu thụ đường trong nho và chuyển đổi nó thành ethanol, carbon dioxide và nhiệt. Các giống nho và chủng nấm men khác nhau tạo ra các kiểu rượu khác nhau.</h2>
    </div>
</div>
<br><br>
<hr><br>
...
<div class="indor-plant-product">
    <div class="row">
        <div class="indoor-product-active">
            ...
            <?php foreach ($listidsp1 as $key => $value) {
